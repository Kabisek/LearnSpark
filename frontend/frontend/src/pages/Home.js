...
//         }}
//         duration={5000}
//         refreshStatuses={() => axios.get("/status").then((res) => setStatuses(res.data))}
//         isEditing={!!editingStatus}
//       />

//       <Leftsidebar />

//       <Box sx={{ flex: 1, maxWidth: 950, mx: "auto", my: 2, p: 2, width: "100%" }}>
//         <Box sx={{ display: "flex", justifyContent: "center", borderBottom: "1px solid #dbdbdb", mb: 3, gap: 3, flexWrap: "wrap" }}>
...
//               }}
//             >
//               {tab === "following" ? "Following" : tab === "all" ? "All Posts" : "My Posts"}
//             </Button>
//           ))}
//         </Box>
...
//           {posts.map((post) => (
//             <Card key={post.id} sx={{ mb: 4, boxShadow: "none", border: "1px solid #dbdbdb", borderRadius: 2 }}>
...
//                     <ListItem key={item.comment.id} disablePadding disableGutters sx={{ mb: 0.5 }}>
...
//                 <Box sx={{ display: "flex", alignItems: "center", mt: 2, pt: 2, borderTop: "1px solid #efefef" }}>
//                   <TextField
//                     fullWidth
